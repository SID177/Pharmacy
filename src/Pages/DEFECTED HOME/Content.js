...
class ContentCls extends Component{
  ...
  componentDidMount(){
    ...
    var loadScript=this.props.loadScript;
    loadScript();
        ...
        <div className="wide-center">
					<div className="information-blocks">
						...
						<div className="products-swiper">
							<div className="" data-autoplay="0" data-loop="0" data-speed="500" data-center="0" data-slides-per-view="responsive" data-xs-slides="2" data-int-slides="2" data-sm-slides="3" data-md-slides="4" data-lg-slides="5" data-add-slides="5">
								<div className="">
